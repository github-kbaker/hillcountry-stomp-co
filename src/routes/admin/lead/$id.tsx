...
import { deleteLead, getLead, getLeadPhoto, getSession, updateLead } from "~/lib/admin";
...
const groups: Array<[string, string[]]> = [
  ["Contact", ["name", "contact_name", "company", "phone", "email", "customer_type", "lead_source", "utm"]],
