...
function LeadDetailPage() {
  ...
  async function save(patch: Record<string, unknown>) { if (!lead) return; setSaving(true); try { const r = await updateLead({ data: { id, patch } }); if (!(r instanceof Response)) setLead(r.lead as LeadDetail); } finally { setSaving(false); } }
